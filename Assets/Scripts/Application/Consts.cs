...
public static class Consts
{
    ...
    //注册
    public const string E_Register = "E_Register";
    //个人信息
    public const string E_ShowPerson = "E_ShowPerson";
    //得分排行榜
    public const string E_ShowRank = "E_ShowRank";
    ...
    public const string V_LoginSign = "V_LoginSign";
}
